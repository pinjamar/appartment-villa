...
const Calendar: React.FC<CalendarProps> = ({ currentLanguage }) => {
  ...
  const monthNames = currentLanguage === 'hr' 
    ? ['Siječanj', 'Veljača', 'Ožujak', 'Travanj', 'Svibanj', 'Lipanj', 'Srpanj', 'Kolovoz', 'Rujan', 'Listopad', 'Studeni', 'Prosinac']
    : ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];

  const dayNames = currentLanguage === 'hr'
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-600">
                    {currentLanguage === 'hr' ? 'Visoka Sezona' : 'High Season'} (€250/noć)
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 bg-green-50 border border-green-200 rounded"></div>
                  <span className="text-gray-600">
                    {currentLanguage === 'hr' ? 'Niska Sezona' : 'Low Season'} (€180/noć)
                  </span>
                </div>
                <div className="flex items-center space-x-2">
